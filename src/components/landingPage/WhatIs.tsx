...
const WhatIs: React.FunctionComponent = () => {
  return (
        ...
        <Grid.Unit df={6} lg={6} md={12}>
          ...
          <>
            <FormattedMessage id={gt("paragraphs.0")}>
              {paragraph => (
                <Paragraph key="paragraphs.0">{paragraph}</Paragraph>
              )}
            </FormattedMessage>
            <FormattedMessage id={gt("paragraphs.1")}>
              {paragraph => (
                <Paragraph key="paragraphs.1">{paragraph}</Paragraph>
              )}
            </FormattedMessage>
            <Paragraph>
              <FormattedMessage
                ...
                values={{
                  link: (
                    <Link.Internal to="/blog/xxxlutz-video" withUnderline>
