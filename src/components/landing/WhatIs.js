            ...
            <div className="container">
                <div className="row row--space-between row--sm-align-center">
                    <div className="col-5 col-md-6 col-sm-9">
                        <svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 445 404" xmlSpace="preserve" aria-labelledby="treasure-title">
                    ...
                    <div className="col-6 col-md-9 col-sm-12 content-inverse">
                        ...
                        <div>
                            ...
                            <p>It provides the last mile capabilities that a developer needs to build a cloud-native application using several open-source projects under the Cloud Native Computing Foundation (CNCF), such as Kubernetes, Istio, NATS, Kubeless, and Prometheus, to name a few.</p>
                            <p>It is designed natively on Kubernetes and, therefore, it is portable to all major cloud providers.</p>
                            <a href="https://github.com/kyma-project" className="btn btn-github">
                                <svg className="sprite-icon sprite-icon--28 sprite-icon--inverse" role="img" aria-labelledby="buttonGithub">
