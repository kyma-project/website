...
``` text
  ...
  │    ├── early-adopters         # Raw content for "Early adopters" section in landing page
  ...
  ├── netlify                     # Sources of lambdas running in Netlify platform
  ...
  │    ├── root                   # Source of application wrapper
  │    ├── sitemetadata           # Extractor of metadata for pages
  │    ├── types                  # Types separated by page contexts
  │    └── views                  # Template files, for example, for a blog post, documentation page etc.
