...
As a contributor, you must follow certain guidelines and rules.

## Naming guidelines

To learn how to name objects in the Kyma project, read [this](../guidelines/technical-guidelines/naming.md) document.

## Documentation types

Go to [this](https://github.com/kyma-project/community/blob/master/guidelines/templates/README.md) document to see an overview of document templates used in specific Kyma repositories. The templates themselves are collected in the [`resources`](../guidelines/templates/resources/) subfolder in the `community` repository.
...
5. Commit and push changes to your new branch. Create a clear and descriptive commit message in which you specify what you have changed. See the [`git-workflow.md`](./03-git-workflow.md) document for commit message guidelines.
...
To learn more about maintainers' responsibilities and rules for appointing new maintainers, and removing the existing ones, refer to the [governance.md](../governance/governance.md) document.
