...
- Ahmed Abdalla, [the leader of the Kyma's Core SIG](https://github.com/kyma-project/community/blob/main/collaboration/02-sig-core.md) and our Lead Product Engineer
- Piotr Kopczynski, [the leader of the Kyma's Core SIG](https://github.com/kyma-project/community/blob/main/collaboration/02-sig-core.md) and the owner of the Kyma's Service Catalog capability
- Lukasz Gornicki, [the leader of the Kyma's Core SIG](https://github.com/kyma-project/community/blob/main/collaboration/02-sig-core.md) and the owner of the Kyma's Core and Supporting capability
