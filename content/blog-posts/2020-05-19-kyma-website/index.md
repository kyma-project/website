...
Before your merge a PR and the content gets published on the Kyma website, you can preview your changes. This way you can see if the formatting of the text is correct, images fit well, and links work as expected. That is possible thanks to the [preview feature](https://kyma-project.io/community/guidelines/content-guidelines/10-docs-preview/) provided by Netlify. It attaches links to autogenerated previews of website views to your PRs.
...
1. [Fork](https://kyma-project.io/community/contributing/03-git-workflow/) a repo.
2. Create a PR.
