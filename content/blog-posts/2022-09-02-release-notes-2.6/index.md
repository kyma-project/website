...
You probably know the song ["Kyma, Kyma, Kyma, Kyma, Kyma chameleon"](https://www.youtube.com/watch?v=JmcA9LIIXWw). Like chameleons, Kyma easily adapts to new surroundings, which you can see in the new release. In 2.6 we introduce a new version of APIRule, and configurable logging. But that's not all! Read on to find out more about the 2.6 release!
