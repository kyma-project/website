...
- Update of components (https://github.com/kyma-project/kyma/issues/17378)
  ...
  - Alertmanager 0.25.0
- [Switching to custom binaries](https://github.com/kyma-project/kyma/issues/17378) to update base dependencies independent of the release cycle for:
  - Alertmanager
  - Node-exporter
...
- Trace context attributes conforming to w3c-tracecontext have been added to the access log format (https://github.com/kyma-project/kyma/pull/17304)
