...
Kyma packages its components into [Helm](https://github.com/helm/helm/) charts that the [Installer](https://github.com/kyma-project/kyma/tree/master/components/installer) uses.
